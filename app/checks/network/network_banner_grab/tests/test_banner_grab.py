...
_SYNC_TCP_READ = "app.checks.network.network_banner_grab.check.BannerGrabCheck._sync_tcp_read"
...
class TestBannerGrabCheckInit:
    ...
    def test_check_metadata(self):
        ...
        assert check.name == "network_banner_grab"
    ...
    def test_banner_signatures_defined(self):
        from app.checks.network.network_banner_grab.check import BANNER_SIGNATURES
    ...
    def test_http_ports_excluded(self):
        from app.checks.network.network_banner_grab.check import HTTP_PORTS
