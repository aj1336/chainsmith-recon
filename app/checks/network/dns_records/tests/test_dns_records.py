...
from app.checks.network.dns_records.check import HAS_DNSPYTHON
...
class TestDnsRecordCheckRun:
    ...
    @patch("app.checks.network.dns_records.check.dns.resolver.Resolver")
    ...
    @patch("app.checks.network.dns_records.check.HAS_DNSPYTHON", False)
